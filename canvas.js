...
// 得到基于页面左顶点的位置，client始终为当前视图的相对位置，root.left 和 scrollLeft得到偏移位置
...
// 点击以重新开始游戏，对应 showingWinScreen 的状态，类似路由功能
...
// 以每秒多少帧更新动画，给canvas添加两个鼠标事件，点击重新开始/移动更新位置
// 以30帧每秒的频率根据状态的变化完成页面更新
